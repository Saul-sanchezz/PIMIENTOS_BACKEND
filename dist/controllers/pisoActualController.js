...
exports.registrarPisoActual = exports.obtenerPisoActualId = exports.obtenerPisoActualAll = exports.eliminarPisoActualId = exports.editarPisoActualId = void 0;
var _PisoActual = _interopRequireDefault(require("../models/PisoActual.js"));
...
const registrarPisoActual = async (req, res) => {
  ...
  const productoAgregar = new _PisoActual.default(req.body);
  try {
...
exports.registrarPisoActual = registrarPisoActual;
const obtenerPisoActualAll = async (req, res) => {
  try {
    const pisoActual = await _PisoActual.default.find();
...
exports.obtenerPisoActualAll = obtenerPisoActualAll;
const obtenerPisoActualId = async (req, res) => {
  ...
  try {
    const producto = await _PisoActual.default.findById(id);
    if (!producto) {
...
exports.obtenerPisoActualId = obtenerPisoActualId;
...
exports.editarPisoActualId = editarPisoActualId;
...
exports.eliminarPisoActualId = eliminarPisoActualId;