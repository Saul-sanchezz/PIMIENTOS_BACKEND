...
exports.registrarPisoAnterior = exports.obtenerPisoAnteriorId = exports.obtenerPisoAnteriorAll = exports.eliminarPisoAnteriorId = exports.editarPisoAnteriorId = void 0;
var _PisoAnterior = _interopRequireDefault(require("../models/PisoAnterior.js"));
...
const registrarPisoAnterior = async (req, res) => {
  ...
  const productoAgregar = new _PisoAnterior.default(req.body);
  try {
...
exports.registrarPisoAnterior = registrarPisoAnterior;
const obtenerPisoAnteriorAll = async (req, res) => {
  try {
    const pisoAnterior = await _PisoAnterior.default.find();
...
exports.obtenerPisoAnteriorAll = obtenerPisoAnteriorAll;
const obtenerPisoAnteriorId = async (req, res) => {
  ...
  try {
    const producto = await _PisoAnterior.default.findById(id);
    if (!producto) {
...
exports.obtenerPisoAnteriorId = obtenerPisoAnteriorId;
...
exports.editarPisoAnteriorId = editarPisoAnteriorId;
...
exports.eliminarPisoAnteriorId = eliminarPisoAnteriorId;